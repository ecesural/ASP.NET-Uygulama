<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="haberler.aspx.cs" Inherits="AspTemplateUyg.haberler" %>
					...
					<div>
						<div id="news" class="body">
							<div class="sidebar">
								...
								<ul>
									<li>
										<a href="haberler.aspx">2023 Bikini Contest Winners</a>
									</li>
									<li>
										<a href="haberler.aspx">Top 10 Diving Spots</a>
									</li>
									<li>
										<a href="haberler.aspx">Fishing ban to be implemented this year</a>
									</li>
									<li>
										<a href="haberler.aspx">Lifeguard saves child from drowning</a>
									</li>
								</ul>
								<h3>Vaction Tips</h3>
								<ul>
									<li>
										<a href="haberler.aspx">What to bring on the beach?</a>
									</li>
									<li>
										<a href="haberler.aspx">Planning Fun Activities</a>
									</li>
									<li>
										<a href="haberler.aspx">Diving Checklist</a>
									</li>
									<li>
										<a href="haberler.aspx">First Aid</a>
									</li>
									<li>
										<a href="haberler.aspx">How to Build a Sand Castle?</a>
									</li>
									<li>
										<a href="haberler.aspx">Tanning Tips</a>
									</li>
								</ul>
							</div>
							<div>
